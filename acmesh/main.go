...
func (c *customDNSProviderSolver) Present(ch *v1alpha1.ChallengeRequest) error {
  ...
  process, err := os.StartProcess("/root/acme_delegate", []string{
    cfg.DNSAPI, "add", extractRecordName(ch.ResolvedFQDN, ch.ResolvedZone), ch.Key,
  }, procAttr)
  if err != nil {
    return err
  }
...
func (c *customDNSProviderSolver) CleanUp(ch *v1alpha1.ChallengeRequest) error {
  ...
  process, err := os.StartProcess("/root/acme_delegate", []string{
    cfg.DNSAPI, "rm", extractRecordName(ch.ResolvedFQDN, ch.ResolvedZone), ch.Key,
  }, procAttr)
  if err != nil {
    return err
  }
