...
const (
  ...
  LAUNCHER_SOCK             = "unix://" + SYNOPKG_RUNTIME + SYNOPKG_PKGNAME + "-launcher.sock"
  SOCK_FILE                 = "unix://" + SYNOPKG_RUNTIME + SYNOPKG_PKGNAME + ".sock"
  PID_FILE                  = SYNOPKG_RUNTIME + SYNOPKG_PKGNAME + ".pid"
  ENV_FILE                  = SYNOPKG_RUNTIME + SYNOPKG_PKGNAME + ".env"
  LOG_FILE                  = SYNOPKG_RUNTIME + SYNOPKG_PKGNAME + ".log"
  LAUNCH_PID_FILE           = SYNOPKG_RUNTIME + SYNOPKG_PKGNAME + "-launcher.pid"
  LAUNCH_LOG_FILE           = SYNOPKG_RUNTIME + SYNOPKG_PKGNAME + "-launcher.log"
  INST_LOG                  = SYNOPKG_RUNTIME + SYNOPKG_PKGNAME + "_install.log"
